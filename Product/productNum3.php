...
<body>
	...
	<?php include ('../Common/productCommon.php'); ?>
		...
		<span class="position">您现在的位置是：<span class="position1">产品中心</span> &gt;&gt;<span class="position2">尿液分析</span></span>
	</div>				
	<!-- 清除浮动 -->
	<div class="clearboth"></div>
		...
		<div class="product-box">
			...
			<div class="magnifier">
				<div class="m_image">
				    <img src="../images/products/421.jpg" width="300" height="300" />
				</div>
				<div class="m_thumb">
				    ...
				    <div  id="picnow" class="m_thumb_img">
				        <ol class="clearfix">
							...
							$sql = "SELECT * FROM `product` WHERE `产品分类` = '尿液分析系列'  ";
