...
CREATE TABLE IF NOT EXISTS `job` (
  ...
  `gangwei` varchar(150) NOT NULL,
  `xueli` varchar(200) NOT NULL,
  `zhuanye` varchar(100) NOT NULL,
  `num` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `job` (`id`, `style`, `position`, `gangwei`, `xueli`, `zhuanye`, `num`) VALUES
(1, '研发类', '生化类', '核酸试剂研发工程师', '硕士及以上', '分子细胞遗传学、医学检验、分子生物技术等相关专业', 24),
(2, '研发类', '生化类', '试剂研发工程师', '本科及以上', '化学、生物、药学、医学检验等相关专业 ', 2),
(3, '研发类', '生化类', '抗体研发工程师', '本科及以上', '生物化学、分子生物学、微生物学、临床检验或医学等相关专业', 2),
(4, '研发类', '生化类', '产品溯源工程师', '本科及以上', '生物化学、生物技术、生化制药等相关专业', 1),
(5, '研发类', '生化类', '电子研发工程师', '本科及以上', '电子、自动化等相关专业', 5),
(6, '研发类', '硬件类', '电子研发工程师', '本科及以上', '电子、自动化等相关专业 ', 5),
(7, '研发类', '硬件类', '超声探头工程师', '本科及以上', '物理学、电子学等相关专业', 1),
(8, '研发类', '机械类', '液路设计工程师', '本科及以上', '机械、流体力学等相关专业', 1),
(9, '研发类', '机械类', '机械研发工程师', '本科及以上', '机械设计、制造、材料、工艺等相关专业', 0),
(10, '研发类', '硬件类', '光学工程师', '硕士及以上', '光学、光电子学、精密仪器（偏光学方向）等相关专业 ', 1),
(11, '研发类', '软件类 	', '图像处理工程师', '本科及以上', '软件工程、计算机科学与技术等相关专业', 1),
(12, '工程类', '临床类临床应用工程师', '临床应用工程师', '本科及以上', '临床医学、医学检验等相关专业', 2),
(13, '营销类', '销售类', '驻外销售代表', '本科及以上', '医学检验或医学类相关专业 ', 0),
(14, '营销类', '测试', '测试', '测试', '测试', 0),
(15, '', '', '', '', '', 0),
(16, '工程类', '测试', '测试', '测试', '测试', 1);
...
(9, '第十四届贵阳医疗器械、设备技术展览会', '2013-03-01', '<p> 《第十四届贵阳医疗器械、设备技术展览会》定于2013年3月27-29日在贵阳新展览中心举行，我公司展位为特17号，届时欢迎新老客户光临。</p>', 11),
(10, '测试', '2015-06-10', '12', 5);
...
(8, '优利特集团举行2013年升旗仪式', '', 'http://127.0.0.1/0511school/images/news/3_08.jpg', '2015-05-20', 0),
...
INSERT INTO `table` (`id`, `company`, `caption`, `rep`, `area`, `cer`, `establish`, `username`, `job`, `tel`, `asset`, `sales`, `industry`) VALUES
(1, '桂林电子科技大学', '桂电', '桂电', '1000', '证书4', '2015-06-09', '黄艺华', 'stu', '13788742565', '3000', '2000', '1000'),
(2, '12', '12', '12', '12', '12', '0000-00-00', '', '', '', '', '', ''),
(3, '测试', '201', '黄艺华', '10000', '200', '2012-10-12', '黄艺华', '桂电', '1345456', '13431', '24531', '4545'),
(4, '测试', '201', '黄艺华', '10000', '200', '2012-10-12', '黄艺华', '桂电', '1345456', '13431', '24531', '4545');
...
(11, 'stu005', '96e79218965eb72c92a549dd5a330112', '福福福福', '1234@123.com', 0),
(13, 'stu008', '96e79218965eb72c92a549dd5a330112', '单词', '1234@123.com', 0),
(14, 'stu9', '123456', '桂林电子', 'hyhning@163.com', 0),
(15, '', '', '', '', 0);
...
CREATE TABLE IF NOT EXISTS `xuanjiang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `xuanjiang` (`id`, `city`, `xuexiao`, `shijian`, `didian`, `logo`) VALUES
(2, '桂林', '桂林电子科技大学', '2015-06-10', '桂林', 'http://127.0.0.1/0511school/images/capture/4_04.jpg'),
(3, '桂林', '测试', '2015-01-01', '测试1', 'http://127.0.0.1/0511school/images/capture/4_05.jpg'),
(4, '南宁', '测试', '2015-01-01', '测试', 'http://127.0.0.1/0511school/images/capture/4_07.jpg'),
(5, '成都', '测试', '2015-01-01', '测试', 'http://127.0.0.1/0511school/images/capture/4_08.jpg');
