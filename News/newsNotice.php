		...
		<div class="container">
			<div class="main">
				<div class="title">
					...
					<span class="position">您现在的位置是：<span class="position1">新闻快讯</span> &gt;&gt;<span class="position2">展会公告</span></span>
				</div>
				<!-- 清除浮动 -->
				<div class="clearboth"></div>					
					<div class="exhibition maintext">
						...
						<?php
							...
							$sql = "SELECT * FROM `new2` ORDER BY id DESC";
							$query = mysql_query($sql);
							while($rs = mysql_fetch_array($query)){
						?>
						<p><a href="newView2.php?id=<?php echo $rs['id'] ?>"><?php echo $rs['title'] ?><span><?php echo $rs['dates'] ?></span></a></p>
						<?php
						}
						?>
					</div>					
